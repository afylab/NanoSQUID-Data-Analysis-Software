...
Data1 = TFScanDataProcessor(11884);
Data2 = TFScanDataProcessor(11885);
...
[Output] = InterpolateIntegrateAndMask(Data, DataX, DataY, angle, amplitude);

sumData.x = DataX;
sumData.y = DataY;
sumData.z = GaussFilter(Output, 31);
...
axis equal
colorbar
title('Subtracted Data Before Integration')

subplot(1,2,2)
pcolor(DataX, DataY, sumData.z);
colormap(redblue(1000))
shading flat
axis equal
colorbar
